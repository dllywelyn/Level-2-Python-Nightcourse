...
###### Make easy, medium and hard modes. Medium = keep code the same. 
# EASY = e
# with added instructions/hints  and a miracle of god:
...
while True:
    ...
    print("")
    middle("Your inhabitants enjoy the wealth of 10 acres for each person in your kingdom.")
    middle("Your goal is to improve this whilst keeping your people healthy.")
    print("")
    middle(r"If more than 30% of your population die in any given year")
